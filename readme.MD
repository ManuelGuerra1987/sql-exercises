...
| tran_id | mer_id | card_id | timestamp | amount | prev_tt       | prev_mer | prev_card | prev_amount | diff_min |
|---------------|-------------|----------------|------------------------|--------|----------------------|------------|-----------|-------------|--------------|
...
| t_id | mer_id | card_id | tt | amount | prev_tt      | prev_mer | prev_card | prev_amount | diff_min | same |
|---------------|-------------|----------------|------------------------|--------|----------------------|------------|-----------|-------------|--------------|----------------------|
